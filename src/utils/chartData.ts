...
export const projectShowcase = [
  {
    ...
    github: 'https://github.com/vaibhav1826/Crop_Yield_Prediction',
    demo: null,
    images: [
      '/projects/crop-yield/Screenshot_7.png',
  ...
  },
  {
    ...
    github: 'https://github.com/vaibhav1826/Smart_Payroll_Management_System',
    demo: 'https://shiv-enterprises-three.vercel.app/',
    images: [
      '/projects/smart-payroll/payroll_1.png',
      '/projects/smart-payroll/payroll_2.png',
      '/projects/smart-payroll/payroll_3.png',
    ],
  },
  {
    name: 'Education Platform — Gamified Learning',
    description:
      'Production-ready MERN stack e-learning platform featuring gamified XP & leveling, real-time Socket.io leaderboards, role-based dashboards for students and teachers, quiz engine (MCQ/True-False/Short Answer), PDF certificate generation, Google OAuth, and in-app notification center.',
    stack: ['MongoDB', 'Express.js', 'React.js', 'Node.js', 'Socket.io', 'JWT', 'Framer Motion', 'Nodemailer', 'Tailwind'],
    metric: 'Full gamification engine with XP, streaks, achievements & real-time leaderboard via WebSockets',
    github: 'https://github.com/vaibhav1826/Education_Platform',
    demo: null,
    images: [
      '/projects/education-platform/education_1.png',
      '/projects/education-platform/education_2.png',
      '/projects/education-platform/education_3.png',
    ],
  },
  {
    name: 'Online Portfolio',
    description:
      'Personal developer portfolio built with React + Vite and TypeScript, featuring an animated forest-green theme, interactive skill graph, dynamic resume viewer, D3.js data visualizations, project carousel, and Framer Motion micro-interactions.',
    ...
    images: [
      ...
      '/projects/online-portfolio/online_3.png',
    ],
  },
]
...
export const resumeSections: ResumeSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        title: 'Education Platform — Gamified Learning',
        subtitle:
          'Production-ready MERN platform with gamified XP/leveling, real-time Socket.io leaderboard, dual-role dashboards (student/teacher), quiz engine, PDF certificate generator, Google OAuth, and in-app notification center.',
        period: 'Nov 2025 – Feb 2026',
        description:
          'Tech: MongoDB, Express.js, React.js, Node.js, Socket.io, JWT, Framer Motion, Nodemailer, Tailwind CSS, Vite',
      },
      {
        title: 'Online Portfolio — Developer Showcase',
        subtitle:
          'Personal portfolio with animated forest-green theme, interactive D3.js skill graph, dynamic resume viewer, project carousel with Framer Motion micro-interactions.',
        period: 'Feb 2026 – Present',
        description:
          'Tech: React, TypeScript, Vite, Tailwind CSS, Framer Motion, D3.js, Recharts',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        subtitle:
          'B.Tech — Computer Science and Engineering · CGPA: 8.31',
